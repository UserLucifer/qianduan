...
export default function SettlementsPage() {
  ...
  const sections: DetailSection[] = detail ? [
    {
      title: "结算信息",
      fields: [
        { label: "结算编号", value: <span className="font-mono">{detail.settlementNo}</span> },
        ...
        { label: "本金", value: <MoneyText value={detail.principalAmount} /> },
        { label: "收益", value: <MoneyText value={detail.profitAmount} signed /> },
        { label: "违约金", value: <MoneyText value={detail.penaltyAmount} /> },
        { label: "实际结算", value: <MoneyText value={detail.actualSettleAmount} signed /> },
  ...
  return (
    <div className="space-y-6">
      ...
      <DetailDrawer open={Boolean(detail)} title="结算详情" subtitle={detail?.settlementNo} sections={sections} onClose={() => setDetail(null)} />
    </div>
  );
}
